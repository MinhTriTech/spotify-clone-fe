...
export const GoogleIcon = (props) => (
  ...
  >
    ...
    <path fill="#34A853" d="M130.550 261.100c35.248 0 64.839-11.605 86.453-31.622l-41.196-31.913c-11.024 7.688-25.820 13.055-45.257 13.055-34.523 0-63.824-22.773-74.269-54.250l-1.531.130-40.298 31.187-.527 1.465C35.393 231.798 79.490 261.100 130.550 261.100"/>
    <path fill="#FBBC05" d="M56.281 156.370c-2.756-8.123-4.351-16.827-4.351-25.820 0-8.994 1.595-17.697 4.206-25.820l-.073-1.730-40.603-31.688-1.335.635C5.077 89.644 0 109.517 0 130.550s5.077 40.905 13.925 58.602l42.356-32.782"/>
