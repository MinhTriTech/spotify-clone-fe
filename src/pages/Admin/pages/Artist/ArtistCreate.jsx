        ...
        <>
            ...
            <form action="" method="" style={{ boxShadow: "0 4px 6px rgba(255, 255, 255, 0.2)" }} id="at-form-create" className="text-white w-full px-8 py-8 flex flex-wrap gap-4 h-fit bg-black">
                ...
                <div className="w-full h-fit flex py-4">
                    ...
                    <div className="w-[78%]">
                        <InputCombo type="text" placeholder="Nhập tên nghệ sĩ" label="Tên nghệ sĩ" name="artist" />
                        <div class="w-full px-6">
                            <label for="name">Tiểu sử</label>
                            <textarea class="resize-none bg-black mt-2 w-full h-40 pl-3 pr-4 py-2 border border-spotifyGray rounded-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" type="text" placeholder="Nhập tên sản phẩm" name="name" />
                        </div>
                    </div>
                </div>
            </form>
