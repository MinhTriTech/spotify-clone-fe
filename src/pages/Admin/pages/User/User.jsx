        ...
        <div>
            <div style={{ boxShadow: "0 4px 6px rgba(255, 255, 255, 0.2)" }} className="bg-black w-full h-fit px-4 py-4 font-gilroy rounded-md">
                ...
                <div className="relative w-full flex items-center text-sm">
                    ...
                    <input id="pd-input" type="text" placeholder="Tìm kiếm theo username, Họ và tên, trạng thái" class="w-[40%] h-10 pl-10 pr-4 py-2 border bg-black border-gray-300 rounded-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
